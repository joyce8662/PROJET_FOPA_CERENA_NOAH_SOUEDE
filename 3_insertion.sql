...
(1,'Dupont','Jean','jean.dupont.medecin@email.com','medecin'),
(2,'Martin','Claire','claire.martin.medecin@email.com','medecin'),
(3,'Bernard','Luc','luc.bernard.medecin@email.com','medecin'),
(4,'Petit','Sophie','sophie.petit@email.com','patient'),
(5,'Durand','Marc','marc.durand@email.com','patient'),
(6,'Leroy','Emma','emma.leroy@email.com','patient');
...
(1,1,'Consultation générale, symptômes grippaux.'),
(2,2,'Examen dermatologique pour irritation cutanée.'),
(3,3,'Consultation cardiologique de suivi.');

INSERT INTO AVIS (id_avis, id_consultation, note, commentaire) VALUES
(1,1,5,'Médecin très attentif et professionnel'),
(2,2,4,'Bonne consultation, explications claires');
